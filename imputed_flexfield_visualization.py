...
# Load the imputed FlexField Fitness dataset
imputed_flexfield_fitness_data = pd.read_csv('data/imputed_flexfield_fitness.csv')

# Visualization 1: Fitness Goal vs. Hours at Gym (per week)
plt.figure(figsize=(10, 6))
flexfield_fitness_vs_gym = imputed_flexfield_fitness_data.groupby('Fitness Goal')['Hours at Gym (per week)'].mean()
...
plt.figure(figsize=(10, 6))
flexfield_fitness_vs_membership = imputed_flexfield_fitness_data.groupby('Fitness Goal')['Gym Membership Length (years)'].mean()
...
plt.figure(figsize=(10, 6))
flexfield_fitness_vs_calorie = imputed_flexfield_fitness_data.groupby('Fitness Goal')['Calorie Intake'].mean()
...
plt.figure(figsize=(10, 6))
flexfield_gym_vs_membership = imputed_flexfield_fitness_data.groupby('Hours at Gym (per week)')['Gym Membership Length (years)'].mean()
...
plt.figure(figsize=(10, 6))
flexfield_gym_vs_calorie = imputed_flexfield_fitness_data.groupby('Hours at Gym (per week)')['Calorie Intake'].mean()
...
plt.figure(figsize=(10, 6))
flexfield_membership_vs_calorie = imputed_flexfield_fitness_data.groupby('Gym Membership Length (years)')['Calorie Intake'].mean()
